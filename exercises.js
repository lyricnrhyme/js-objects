...
console.log("My dog " + dog.name + " is " + dog.age + " year(s) old and likes to " + dog.speak);
...
var completePerson = buildPerson(plainPerson, "Jamie", 24);
...
function objectAddition(adding) {
  adding.result = adding.a + adding.b;
...
var sumObjResultA = objectAddition(sumObjA);
console.log(printObj(sumObjA));
...
var sumObjResultB = objectAddition(sumObjB);
console.log(printObj(sumObjB));
